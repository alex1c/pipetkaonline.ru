...
import { ColorPalette } from '@/hooks/usePaletteGenerator'
...
/**
 * Component for displaying generated color palette
 * Shows color swatches with codes and copy buttons
 */
export function PaletteResult({ palette }: PaletteResultProps) {

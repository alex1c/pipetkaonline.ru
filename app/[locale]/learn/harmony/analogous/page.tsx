...
export async function generateMetadata({
	...
	return {
		...generatePageMetadata({ title: t('title'), description: t('description'), locale: resolvedParams.locale, path: '/learn/harmony/analogous' }), title: t('title'), description: t('description') }
}

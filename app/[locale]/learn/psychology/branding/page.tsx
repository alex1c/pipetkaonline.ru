...
export async function generateMetadata({
	...
	return {
		...generatePageMetadata({ title: t('title'), description: t('description'), locale: resolvedParams.locale, path: '/learn/psychology/branding' }), title: t('title'), description: t('description') }
}

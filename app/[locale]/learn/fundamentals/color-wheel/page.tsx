...
export async function generateMetadata({
	...
	return {
		...generatePageMetadata({ title: t('title'), description: t('description'), locale: resolvedParams.locale, path: '/learn/fundamentals/color-wheel' }), title: t('title'), description: t('description') }
}
